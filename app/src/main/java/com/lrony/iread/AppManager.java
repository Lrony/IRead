...
public class AppManager {
    ...
    private class MyActivityLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
        ...
        public void onActivityCreated(Activity activity, Bundle bundle) {
            if (isShowLog) {
                KLog.d(TAG, "onActivityCreated :" + activity);
            }
        ...
        public void onActivityStarted(Activity activity) {
            if (isShowLog) {
                KLog.d(TAG, "onActivityStarted :" + activity);
            }
            mStageActivityCount++;
        }
        ...
        public void onActivityResumed(Activity activity) {
            if (isShowLog) {
                KLog.d(TAG, "onActivityResumed :" + activity);
            }
        ...
        public void onActivityPaused(Activity activity) {
            if (isShowLog) {
                KLog.d(TAG, "onActivityPaused :" + activity);
            }
        ...
        public void onActivityStopped(Activity activity) {
            if (isShowLog) {
                KLog.d(TAG, "onActivityStopped :" + activity);
            }
            mStageActivityCount--;
        }
        ...
        public void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
            if (isShowLog) {
                KLog.d(TAG, "onActivitySaveInstanceState :" + activity);
            }
        }
        ...
        public void onActivityDestroyed(Activity activity) {
            if (isShowLog) {
                KLog.d(TAG, "onActivityDestroyed :" + activity);
            }
